...
var MOBILE_NAV_CLASSNAME = 'w-full flex justify-start p-4';
export function Header() {
    var isSmall = useScreenSize().isSmall;
    return (<div className="fixed top-0 left-auto right-auto z-50 w-full max-w-300 h-20">
      <div className="flex justify-between items-center bg-white/50 backdrop-blur-lg border-2 border-gray-50 rounded-2xl shadow-sm">
        ...
        {isSmall ? (<Drawer>
          ...
          </Drawer>) : (<div className="flex gap-4 py-5 px-10">
            <Link to={'https://vstaffs.mintlify.app/'}>
              <Button variant="ghost">
                <span className="text-title-h6">Docs</span>
              </Button>
