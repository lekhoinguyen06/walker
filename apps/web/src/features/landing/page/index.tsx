import { TH1, TH4, TLarge, TList, TMuted, TPara, TSmall } from '@/components/ui/typo';
import { Button } from '@/components/ui/button';
import { RiAlibabaCloudFill, RiAlipayFill, RiGithubFill, RiGitlabFill, RiLinkedinBoxFill, RiMenu3Line, RiMetaFill, RiNetflixFill, RiNodejsFill, RiNotionFill, RiOpenaiFill, RiVercelFill } from '@remixicon/react'
                ...
                <div className='flex justify-between items-center bg-white/50 backdrop-blur-lg border-2 border-gray-50 rounded-2xl shadow-sm'>
                    ...
                    {isSmall ? (
                        ...
                        <div className='flex gap-2 py-5 px-10'>
                            <Button variant="ghost"><TLarge>Docs</TLarge></Button>
                            <Button variant="ghost"><TLarge>Demo</TLarge></Button>
                            <Button variant="ghost"><TLarge>Github</TLarge><RiGithubFill /></Button>
                            <Button variant="ghost"><TLarge>Pricing</TLarge></Button>
                            <Button variant="ghost"><TLarge>About</TLarge></Button>
                            <Button><TLarge>Try</TLarge><TLarge className='text-red-500'>Concierge</TLarge></Button>
                        </div>
                    )}
                </div>
            </div>
            ...
            <div className='w-full max-w-300 flex flex-col gap-20'>
                <div className='relative w-full h-110 bg-amber-200 mt-10'>
                    <div className='absolute bottom-0 right-0 flex flex-col items-end'>
                        <TH4 className='text-white mr-10 mb-2'>An open-source front-end library to propel an AI-human driven UI/UX future.</TH4>
                ...
                <div className='w-full h-200 p-10 flex flex-col gap-20'>
                    ...
                    <div className='w-full flex justify-evenly'>
                        <div className='p-5'>
                            <TH1 className='size-15 text-red-500 flex items-center'>vstaffs</TH1>
                        </div>
                        <div className='p-5'>
                    ...
                    <div className='flex flex-col gap-10'>
                        ...
                        <div className='flex -space-x-2'>
                            ...
                            <Avatar>
                                <AvatarFallback><TMuted>+</TMuted></AvatarFallback>
                            </Avatar>
                        </div>
                    </div>
                </div>
                ...
                <div className='w-full h-200 p-10 flex flex-col gap-20'>
                    <div>
                        <TH4>Pricing</TH4>
                        <TPara className='mt-2!'>You can also host Walker yourself using the community client at @walker/client</TPara>
                    </div>
                    <div className='w-full flex gap-10 justify-center'>
                        <div className='h-120 min-w-80 rounded-2xl border-2 border-gray-50 shadow-sm flex flex-col gap-10 p-10 bg-white'>
                            ...
                            <div className='w-full h-full overflow-x-scroll'>
                                <TList list={['Feature 1', 'Feature 1', 'Feature 1', 'Feature 1', 'Feature 1', 'Feature 1', 'Feature 1', 'Feature 1', 'Feature 1', 'Feature 1', ]} />
                            </div>
                        </div>
                        <div className='h-120 min-w-80 rounded-2xl border-2 border-gray-50 shadow-sm flex flex-col gap-10 p-10 bg-white'>
                            <div className='w-full flex justify-between items-center'>
                        ...
                        <div className='h-120 min-w-80 rounded-2xl border-2 border-gray-50 shadow-sm flex flex-col gap-10 p-10 bg-white'>
                            <div className='w-full flex justify-between items-center'>
                                ...
                                <Button><TSmall>Try</TSmall><TSmall className='text-red-500'>Concierge</TSmall></Button>
                            </div>
