import { RiAlibabaCloudFill, RiAlipayFill, RiChatAi3Line, RiGitlabFill, RiLinkedinBoxFill, RiMetaFill, RiNetflixFill, RiNodejsFill, RiNotionFill, RiOpenaiFill, RiVercelFill, } from '@remixicon/react';
...
export function LandingPage() {
    ...
    var isSmall = useScreenSize().isSmall;
    return (<div className="w-screen h-screen p-0 m-0 flex flex-col items-center overflow-x-hidden">
      <Header />
      <Button className="fixed bottom-0 right-0 mr-8 mb-8 bg-white shadow-sm p-4 size-16 aspect-square rounded-full group" size="icon" onClick={function () { return setOpen(true); }}>
      ...
      <div className="w-full max-w-300 flex flex-col gap-20">
        ...
        {isSmall ? (<span className="text-paragraph-sm px-2">
            ...
            earth!
          </span>) : (<span className="text-title-h5">
            The idea is simple. How can we help agents to see what the user see?
            The world works on DOM elements, so we send it to the agents. The
            Walker library helps you send what you want, be reactive, and allow
            agent to walk our website. Guiding users, read from live website, or
